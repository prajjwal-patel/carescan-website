...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 pt-14 pb-10 border-t border-slate-800 font-body">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        {/* Clinical Disclaimer Callout Box */}
        <div className="bg-slate-800/80 border border-slate-700/80 rounded-3xl p-5 sm:p-7 flex flex-col md:flex-row items-start gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-3.5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-brand text-2xl font-extrabold tracking-tight text-white">Orqis</span>
          ...
          <div className="space-y-3">
            <h5 className="font-heading text-xs font-bold uppercase tracking-wider text-slate-400">Project Mission</h5>
          ...
          <div className="space-y-3">
            <h5 className="font-heading text-xs font-bold uppercase tracking-wider text-slate-400">Research & Ethics</h5>
            <ul className="space-y-2 text-xs sm:text-sm font-body">
        ...
        {/* Bottom Bar */}
        <div className="pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-body">
