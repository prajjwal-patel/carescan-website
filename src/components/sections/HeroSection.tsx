...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden bg-gradient-to-b from-indigo-50/40 via-stone-50/60 to-white">
      {/* Background Soft Organic Radial Blobs */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-r from-indigo-200/20 via-teal-100/20 to-purple-200/20 rounded-full blur-3xl -z-10 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex justify-center lg:justify-start">
              <Badge variant="iris" pulse size="md">
                Research Project • AI & Quantum Clinical Screening
              </Badge>
            </div>

            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-slate-900 leading-[1.12]">
              Intelligent Oral Screening for{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-teal-600 to-purple-600">
            ...
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              CareScan bridges frontline diagnostic gaps by uniting mobile imaging, deep convolutional feature extraction, and Variational Quantum Classifiers (VQC) for rapid, privacy-preserving triage.
            </p>
        ...
        <div className="mt-16 sm:mt-24 grid grid-cols-2 md:grid-cols-4 gap-4">
          {HERO_METRICS.map((metric, i) => (
            <Card
              ...
              padding="sm"
              organic="subtle"
              className="text-center group hover:border-indigo-200 transition-all"
            >
